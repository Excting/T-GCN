...
def load_assist_data(dataset):
    sz_adj = pd.read_csv(r'F:/project/pycharm/T-GCN/AST-GCN/data/%s_adj.csv' % dataset, header=None)
    adj = np.mat(sz_adj)
    data = pd.read_csv(r'F:/project/pycharm/T-GCN/AST-GCN/data/sz_speed.csv')
    return data, adj
